...
Основание: [согласованная спецификация](specs/nodic-v1.md), [словарь](../CONTEXT.md), [решение о синхронизации](adr/0001-collaboration-and-storage.md). Это технический план реализации; приложение и сервер ещё не созданы.
